...
function () {
  ...
  function WindowDatePicker(opt) {
    ...
    if (this.type != HOUR) {
      ...
      Util.addEventListener(this.els.body.querySelector('.wdp-date-header > div > div:first-child > svg'), [Util.MOUSE_DOWN], this.showArrowButtons ? this.decreaseDateValue : !this.orientation ? this.increaseDateValue : this.decreaseDateValue);
      Util.addEventListener(this.els.body.querySelector('.wdp-date-header > div > div:last-child svg'), [Util.MOUSE_DOWN], this.showArrowButtons ? this.increaseDateValue : this.orientation ? this.increaseDateValue : this.decreaseDateValue);
